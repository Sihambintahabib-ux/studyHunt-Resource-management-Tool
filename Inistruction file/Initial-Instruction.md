...
|---|---|---|---|---|---|---|---|---|---|
| [Folder setup](#create-the-backend-folder-structure) | [Install Dependencies](#install-dependencies) | [configure-typescript](#configure-typescript) + [env](#env)  | utility | middleware | Auth module + User module | Resource module | Review module + Bookmark module | Review module + Bookmark module | Auth module + User module |
